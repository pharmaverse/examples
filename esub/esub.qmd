...
For eSubmission the most common export format used to deliver these to health authorities
...
internal 1-company solutions are by nature not easily accessible and understandable.
...
package versions that you used (e.g. from CRAN)
