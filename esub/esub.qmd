...
to explore replacing `xpts` with `datasetjson` as a transport file to the FDA via 
the eCTD portal. The group successfully submitted the data package in early Fall of 2025 
and has received positive feedback. Stay tuned for updates on the 
[Pilot 5 Website](https://rconsortium.github.io/submissions-pilot5-website/).
...
action that can be used to produce standardized validation reports, such as this
