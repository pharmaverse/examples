...
Then, we use the ARD to build the demogrphics table.
...
One may also build the deomgraphics in the classic way using `tbl_summary()` from a data frame, then extract the ARD from the table object.
