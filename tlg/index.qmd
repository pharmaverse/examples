...
-   **[Oncology Survival Outputs](oncology_survival.qmd)** - Kaplan-Meier plots with risk tables, median survival summaries, best overall response tables, and a subgroup forest plot using ADTTE and ADRS
...
| **Oncology Survival** | — | [KM plot](oncology_survival.qmd#kaplan-meier-plot) / [Survival tables](oncology_survival.qmd#summary-tables) / [BOR table](oncology_survival.qmd#best-overall-response-table) / [Forest plot](oncology_survival.qmd#subgroup-forest-plot) |
...
-   **`{ggsurvfit}`** - Publication-ready Kaplan-Meier and time-to-event figures with native CDISC ADTTE support
-   **`{broom}`** - Extracts tidy, data-frame model output from Cox regression fits — used to build subgroup forest plots
...
-   [{ggsurvfit} package documentation](https://www.danieldsjoberg.com/ggsurvfit/) - Time-to-event figures with CDISC ADTTE support
:::
